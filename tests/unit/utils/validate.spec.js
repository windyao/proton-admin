...
describe('Utils:validate', () => {
  ...
  it('validURL', () => {
    expect(validURL('https://github.com/windyao/proton-admin')).toBe(true)
    expect(validURL('http://github.com/windyao/proton-admin')).toBe(true)
    expect(validURL('github.com/windyao/proton-admin')).toBe(false)
  })
  it('validLowerCase', () => {
